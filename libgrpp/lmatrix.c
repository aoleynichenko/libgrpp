...
void get_transformation_coeffs_csh_to_rsh(int l, int m, double complex *a, double complex *b);


/**
 * Constructs matrices of the Lx, Ly, Lz operators for the given angular momentum L
 * in the basis of real spherical harmonics (rsh).
 */
void construct_angular_momentum_matrices_rsh(int L, double *lx_matrix, double *ly_matrix, double *lz_matrix)
{
    int dim = 2 * L + 1;
    ...
    construct_angular_momentum_matrices_csh(L, lx_matrix_csh, ly_matrix_csh, lz_matrix_csh);
 ...
 */
void construct_angular_momentum_matrices_csh(int L, double *lx_matrix, double *ly_matrix, double *lz_matrix)
{
    int dim = 2 * L + 1;
